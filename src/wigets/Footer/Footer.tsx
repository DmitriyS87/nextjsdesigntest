            ...
            <div className={styles.left}>
                ...
                <div className={cn(styles.block, styles.blockMenu)}>
                    ...
                    <ul className={styles.list}>
                        <li className={styles.listItem}><a>Написать в поддержку</a></li>
                        <li className={styles.listItem}><a>Политика конфиденциальности</a></li>
                        <li className={styles.listItem}><a>Пользовательское соглашение</a></li>
                    </ul>
                </div>
            </div>
